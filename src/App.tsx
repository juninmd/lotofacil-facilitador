            ...
            <div className="bg-white/60 p-5 border border-gray-200/70 rounded-2xl shadow-sm">
              ...
              <fieldset className="mb-6">
                 ...
                 <div className="flex flex-col gap-2">
                   ...
                   <div className="flex flex-col sm:flex-row gap-4">
                      <label className={`flex-1 p-3 rounded border cursor-pointer transition-colors hover:shadow-md focus-within:ring-2 focus-within:ring-purple-500 focus-within:ring-offset-2 ${algorithmType === 'pattern' ? 'bg-purple-100 border-purple-500 ring-1 ring-purple-500' : 'bg-white border-gray-300 hover:bg-gray-50'}`}>
                          <div className="flex items-center gap-2">
                              <input
                                  type="radio"
                                  name="algorithm"
                                  value="pattern"
                                  checked={algorithmType === 'pattern'}
                                  onChange={() => setAlgorithmType('pattern')}
                                  className="w-4 h-4 text-purple-600 focus:ring-purple-500 border-gray-300"
                              />
                              <span className="font-semibold text-gray-800">Padrão de Pares</span>
                          </div>
                          <p className="text-xs text-gray-600 mt-1 ml-6">
                              Associação e Grafos.
                          </p>
                      ...
                      <label className={`flex-1 p-3 rounded border cursor-pointer transition-colors hover:shadow-md focus-within:ring-2 focus-within:ring-purple-500 focus-within:ring-offset-2 ${algorithmType === 'bayesian' ? 'bg-purple-100 border-purple-500 ring-1 ring-purple-500' : 'bg-white border-gray-300 hover:bg-gray-50'}`}>
                          <div className="flex items-center gap-2">
                              <input
                                  type="radio"
                                  name="algorithm"
                                  value="bayesian"
                                  checked={algorithmType === 'bayesian'}
                                  onChange={() => setAlgorithmType('bayesian')}
                                  className="w-4 h-4 text-purple-600 focus:ring-purple-500 border-gray-300"
                              />
                              <span className="font-semibold text-gray-800">Bayesiana (Prob)</span>
                          </div>
                          <p className="text-xs text-gray-600 mt-1 ml-6">
                   ...
                   <div className="flex flex-col sm:flex-row gap-4">
                      <label className={`flex-1 p-3 rounded border cursor-pointer transition-colors hover:shadow-md focus-within:ring-2 focus-within:ring-purple-500 focus-within:ring-offset-2 ${algorithmType === 'xgboost' ? 'bg-purple-100 border-purple-500 ring-1 ring-purple-500' : 'bg-white border-gray-300 hover:bg-gray-50'}`}>
                          <div className="flex items-center gap-2">
                              <input
                                  type="radio"
                                  name="algorithm"
                                  value="xgboost"
                                  checked={algorithmType === 'xgboost'}
                                  onChange={() => setAlgorithmType('xgboost')}
                                  className="w-4 h-4 text-purple-600 focus:ring-purple-500 border-gray-300"
                              />
                              <span className="font-semibold text-gray-800">XGBoost (Novo)</span>
                          </div>
                          <p className="text-xs text-gray-600 mt-1 ml-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-red-600 ring-1 ring-red-400">
                      <h4 className="font-bold text-red-900 mb-3 border-b border-red-200 pb-2 flex justify-between items-center">
                          XGBoost (Novo)
                          <span className="text-[10px] bg-red-100 text-red-800 px-2 py-0.5 rounded-full">Boost</span>
                      </h4>
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          <span className="text-gray-600 text-sm">Média Acertos:</span>
                          <span className="font-bold text-gray-900 text-lg">{simulationResult.xgboost?.averageHits.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between items-center text-xs text-gray-500">
                           <span>14 Pts: <strong className="text-green-600">{simulationResult.xgboost?.accuracyDistribution[14] || 0}</strong></span>
                           <span>15 Pts: <strong className="text-yellow-600">{simulationResult.xgboost?.accuracyDistribution[15] || 0}</strong></span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-pink-800 ring-1 ring-pink-600">
                      <h4 className="font-bold text-pink-900 mb-3 border-b border-pink-300 pb-2 flex justify-between items-center">
                          Bayesiana
                          <span className="text-[10px] bg-pink-100 text-pink-900 px-2 py-0.5 rounded-full">Prob</span>
                      </h4>
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          <span className="text-gray-600 text-sm">Média Acertos:</span>
                          <span className="font-bold text-gray-900 text-lg">{simulationResult.bayesian?.averageHits.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between items-center text-xs text-gray-500">
                    ...
                    <div className="bg-white p-4 rounded-lg shadow-md border-l-4 border-cyan-800 ring-1 ring-cyan-600">
                      <h4 className="font-bold text-cyan-900 mb-3 border-b border-cyan-300 pb-2 flex justify-between items-center">
                          Padrão de Pares
                          <span className="text-[10px] bg-cyan-100 text-cyan-900 px-2 py-0.5 rounded-full">Grafos</span>
                      </h4>
                      <div className="space-y-3">
                        <div className="flex justify-between items-center">
                          <span className="text-gray-600 text-sm">Média Acertos:</span>
                          <span className="font-bold text-gray-900 text-lg">{simulationResult.pattern?.averageHits.toFixed(2)}</span>
                        </div>
                        <div className="flex justify-between items-center text-xs text-gray-500">
                           <span>14 Pts: <strong className="text-green-600">{simulationResult.pattern?.accuracyDistribution[14] || 0}</strong></span>
                           <span>15 Pts: <strong className="text-yellow-600">{simulationResult.pattern?.accuracyDistribution[15] || 0}</strong></span>
                        </div>
                      </div>
                    </div>
